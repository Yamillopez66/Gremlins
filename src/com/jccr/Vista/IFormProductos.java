 ...
 * IFormCliente.java
 *
 * Created on 19 de mayo de 2012, 10:47 PM
 */
...
public void cargarTablaProductos(String where){
    ...
    Object[] NombreColumnas = {"REF", "NOMBRE DEL PRODUCTO", "VALOR"};
    ...
    this.tablaProductos.getColumnModel().getColumn(1).setPreferredWidth(600);
    ...
    this.tablaProductos.getColumnModel().getColumn(2).setCellRenderer(this.modeloAlinearDerecha);
    TableRowSorter<TableModel> tablaOrdenada = new TableRowSorter<TableModel>(this.dtm_Productos);
...
private void mostrarFichaProductos(int id, String nomProd){
    this.myJDialogFichaProducto = new JDialogFichaProducto(this.myPrincipalForm, true, 
            this, id, nomProd, true, this.terminal, this.sesion, this.idUser);
    this.myJDialogFichaProducto.setVisible(true);
}

private void cmdNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNuevoActionPerformed
// TODO add your handling code here:
    /*int id = this.myPrincipalForm.getmyEmpresaVentas().getNumProducto();
    String nom = "";
    this.myJDialogFichaProducto = new JDialogFichaProducto(this.myPrincipalForm, true, 
            this, id, nom, false, this.terminal, this.sesion, this.idUser);
    this.myJDialogFichaProducto.setVisible(true);*/
